...
$sql0[] = "INSERT INTO dictionary (updated, lang, area, what, xkey, xval, xlock, xon) VALUES (NOW(), 'it', 'admin', 'x3form_builder', '_X3FB_EXTRA_SUGGESTION', 'Per la formattazione del campo (esempio per valori numerici class=\"text-right\")', 0, 1)";
...
$sql0[] = "INSERT INTO dictionary (updated, lang, area, what, xkey, xval, xlock, xon) VALUES (NOW(), 'en', 'admin', 'x3form_builder', '_X3FB_EXTRA_SUGGESTION', 'Formatting of the field (eg for numerical values class=\"text-right\")', 0, 1)";
...
$sql0[] = "INSERT INTO dictionary (updated, lang, area, what, xkey, xval, xlock, xon) VALUES (NOW(), 'it', 'admin', 'x3form_builder', '_X3FB_HELP', 'Scegliere il tipo di campo pi&ugrave; adatto all\'informazione da raccogliere per visualizzare l\'aiuto.', 0, 1)";
...
// en
$sql0[] = "INSERT INTO dictionary (updated, lang, area, what, xkey, xval, xlock, xon) VALUES (NOW(), 'en', 'admin', 'x3form_builder', '_X3FB_HELP', 'Choose the type of field more suited to information gathering to see the help message.', 0, 1)";
...
$sql0[] = "INSERT INTO dictionary (updated, lang, area, what, xkey, xval, xlock, xon) VALUES (NOW(), 'en', 'admin', 'x3form_builder', '_X3FB_HELP_FILE', '<strong>Instructions to complete the FILE FIELD</strong>:<br /><ul><li><strong>Label</strong>: insert short description of the field</li><li><strong>Field Name</strong>: required, please do not use a term used for other fields</li><li><strong>Suggestion</strong>: if you feel necessary, enter a hint to the user</li><li><strong>Default value</strong>: leave blank</li><li><strong>Conditions for the field</strong>: if you want to make it compulsory for uploading a file set it as <strong>required</strong></li><li><strong>Optional Extras</strong>: leave blank</li></ul>', 0, 1)";
