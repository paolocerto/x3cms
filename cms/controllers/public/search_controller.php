...
class Search_controller extends X4Cms_controller
{
	...
	public function _default()
	{
		...
		if ($is_post || $is_get)
		{
			...
			$msg = new Obj_msg(_SEARCH_RESULT, _SEARCH_OF.' <strong>'.addslashes($searched).'</strong>'.$tmp, ['Hn' => 'h1']);
		}
		else
		{
			// empty request
			$msg = new Obj_msg(_SEARCH_RESULT, '<p>'._SEARCH_MSG_SEARCH_EMPTY.'</p>', ['Hn' => 'h1']);
		}
