...
(NOW(), 4, 'english', 'en', 'PWA area ', 'PWA area description', 'some keywords', 1, 0, 0, 1),
(NOW(), 4, 'italiano', 'it', 'PWA area', 'PWA area descrizione', 'keywords', 0, 0, 0, 1);
...
INSERT INTO `areas` (`id`, `updated`, `name`, `title`, `description`, `folder`,  `id_site`, `id_theme`, `xdefault`, `private`,`xlock`, `xon`) VALUES
...
(4, NOW(), 'pwa', 'PWA area', 'Progressive Web App area', 'pwa', 1, 2, 0, 1, 0, 1);
...
(NOW(), 'it', 'admin', 'global', '_ALL', 'Tutti', 0, 1),
(NOW(), 'it', 'admin', 'global', '_TRUE', 'Vero', 0, 1),
(NOW(), 'it', 'admin', 'global', '_FALSE', 'Falso', 0, 1),
...
(NOW(),	'it', 'admin', 'global', '_EXPORT', 'Esporta',	0, 1),
...
(NOW(), 'it', 'admin', 'global', '_AUTOCOMPLETE', 'Autocompletamento', 0, 1),
(NOW(), 'it', 'admin', 'global', '_LEGEND', 'Legenda', 0, 1),
(NOW(), 'it', 'admin', 'global', '_XFROM', 'Dal', 0, 1),
(NOW(), 'it', 'admin', 'global', '_XTO', 'Al', 0, 1),
(NOW(), 'it', 'admin', 'global', '_ONLY_FOR_INTERNAL_USE', 'Solo per uso interno', 0, 1),
...
(NOW(), 'it', 'admin', 'msg', '_ALREADY_EXISTS', 'Esiste già un elemento XXXWHATXXX con lo stesso XXXFIELDXXX', 0, 1),
...
(NOW(), 'it', 'admin', 'info', '_INFO_NGINX', 'Web server Nginx', 0, 1),
...
(NOW(), 'it', 'admin', 'menus', '_MENU_MODE', 'Visualizzazione', 0, 1),
(NOW(), 'it', 'admin', 'menus', '_ONLY_TEXT', 'Solo testo', 0, 1),
(NOW(), 'it', 'admin', 'menus', '_ONLY_ICON', 'Solo icona', 0, 1),
(NOW(), 'it', 'admin', 'menus', '_TEXT_ICON', 'Icona e testo responsive', 0, 1),
...
(NOW(), 'it', 'admin', 'pages', '_IN_MENU', 'In menu', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_PAGE_POSITION', 'Posizione pagina', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_FAKE_PAGE', 'Pagina finta', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_FAKE_PAGE_MSG', 'Solo voce di menù', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_ACTION_PAGE', 'Azione per pagina finta', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_ACTION_PAGE_MSG', 'Non impostate azioni per sottomenù', 0, 1),

(NOW(), 'it', 'admin', 'pages', '_ICON', 'Icona', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_ICON_MSG', 'Da <a href="https://fontawesome.com/v6/search">https://fontawesome.com/v6/search</a>', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_KEYS_MSG', 'In amministrazione puoi usare chiavi per raggruppare sottopagine in un menù', 0, 1),

(NOW(), 'it', 'admin', 'pages', '_CLASS', 'Stile CSS', 0, 1),
(NOW(), 'it', 'admin', 'pages', '_CLASS_MSG', 'Classe CSS per personalizzare voce di menù', 0, 1),
...
(NOW(), 'it', 'admin', 'users', '_SHOW_ONLY_WITH_PRIVS', 'Mostra solo con permessi', 0, 1),
...
(NOW(), 'it', 'admin', 'bulk', '_BULK_ACTION', 'Seleziona azione', 0, 1),
(NOW(), 'it', 'admin', 'bulk', '_BULK_DELETE', 'Elimina selezionati', 0, 1),
(NOW(), 'it', 'admin', 'bulk', '_BULK_UPDATE', 'Aggiorna selezionati', 0, 1),
...
(NOW(), 'en', 'admin', 'global', '_MAINTENANCE_MODE', 'Maintenance mode', 0, 1),
...
INSERT INTO `dictionary` (`updated`, `lang`, `area`, `what`, `xkey`, `xval`, `xlock`, `xon`) VALUES
(NOW(), 'en', 'admin', 'global', '_ALL', 'All', 0, 1),
(NOW(), 'en', 'admin', 'global', '_TRUE', 'True', 0, 1),
(NOW(), 'en', 'admin', 'global', '_FALSE', 'False', 0, 1),
...
(NOW(),	'en', 'admin', 'global', '_EXPORT', 'Export',	0, 1),
...
(NOW(), 'en', 'admin', 'global', '_AUTOCOMPLETE', 'Autocomplete', 0, 1),
(NOW(), 'en', 'admin', 'global', '_LEGEND', 'Legend', 0, 1),
(NOW(), 'en', 'admin', 'global', '_XFROM', 'From', 0, 1),
(NOW(), 'en', 'admin', 'global', '_XTO', 'To', 0, 1),
(NOW(), 'en', 'admin', 'global', '_ONLY_FOR_INTERNAL_USE', 'Only for internal use', 0, 1),
(NOW(), 'en', 'admin', 'global', '_FILTER', 'Filter', 0, 1),
(NOW(), 'en', 'admin', 'global', '_FILTER_MSG', 'Insert a text to filter', 0, 1),
(NOW(), 'en', 'admin', 'global', '_ENTER_TO_FILTER', 'Enter to filter', 0, 1),
...
(NOW(), 'en', 'admin', 'msg', '_ALREADY_EXISTS', 'Already exists an item XXXWHATXXX with the same XXXFIELDXXX', 0, 1),
...
(NOW(), 'en', 'admin', 'info', '_INFO_NGINX', 'Web server Nginx', 0, 1),
...
(NOW(), 'en', 'admin', 'menus', '_MENU_MODE', 'Display mode', 0, 1),
(NOW(), 'en', 'admin', 'menus', '_ONLY_TEXT', 'Only text', 0, 1),
(NOW(), 'en', 'admin', 'menus', '_ONLY_ICON', 'Only Icon', 0, 1),
(NOW(), 'en', 'admin', 'menus', '_TEXT_ICON', 'Icon and text responsive', 0, 1),
...
(NOW(), 'en', 'admin', 'pages', '_IN_MENU', 'In menu', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_PAGE_POSITION', 'Page position', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_AFTER', 'After', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_FAKE_PAGE', 'Fake page', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_FAKE_PAGE_MSG', 'Only a menu item', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_ACTION_PAGE', 'Action for fake page', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_ACTION_PAGE_MSG', 'Not set actions for submenu', 0, 1),

(NOW(), 'en', 'admin', 'pages', '_ICON', 'Icon', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_ICON_MSG', 'From <a href="https://fontawesome.com/v6/search">https://fontawesome.com/v6/search</a>', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_KEYS_MSG', 'In admin you can use keys to group items in subpages menù', 0, 1),

(NOW(), 'en', 'admin', 'pages', '_CLASS', 'CSS Style', 0, 1),
(NOW(), 'en', 'admin', 'pages', '_CLASS_MSG', 'CSS class to personalize menù item', 0, 1),
...
(NOW(), 'en', 'admin', 'users', '_SHOW_ONLY_WITH_PRIVS', 'Show only with permissions', 0, 1),
...
(NOW(), 'en', 'admin', 'bulk', '_BULK_ACTION', 'Select action', 0, 1),
(NOW(), 'en', 'admin', 'bulk', '_BULK_DELETE', 'Delete selected', 0, 1),
(NOW(), 'en', 'admin', 'bulk', '_BULK_UPDATE', 'Update selected', 0, 1),
...
INSERT INTO `menus` (`updated`, `id_theme`, `name`, `description`, `mode`, `xlock`, `xon`) VALUES
(NOW(), 1, 'user_menu', 'User menu', 0, 1, 1),
(NOW(), 1, 'admin_global', 'Global menu', 0, 1, 0),
(NOW(), 1, 'sidebar', 'Left menu', 0, 0, 1),
(NOW(), 2, 'menu_top', 'Top menu', 0, 0, 1);
...
(NOW(), 1, 'site', 'messages', 'Enable/disable messages feature', '0|1', '1', 1, 0, 1),
(NOW(), 1, 'site', 'tasks', 'Enable/disable tasks feature', '0|1', '1', 1, 0, 1),
...
INSERT INTO `sections` (`id`, `updated`, `id_area`, `id_page`, `name`, `progressive`, `settings`, `articles`, `show_author`, `show_date`, `comments`, `xlock`, `xon`) VALUES
(1, NOW(), 2, 1, 's1', 1, '', '0665f9f126a93750d68c49acde91c0ac',  0, 0, 0, 0, 1),
(2, NOW(), 2, 5, 's1', 1, '', '0665f9f126a93750d68c49acde91c0ac', 0, 0, 0, 0, 1),
(3, NOW(), 3, 6, 's1', 1, '', '0665f9f126a93750d68c49acde91c0ac', 0, 0, 0, 0, 1),
(4, NOW(), 3, 10, 's1', 1, '', '0665f9f126a93750d68c49acde91c0ac', 0, 0, 0, 0, 1);
...
(1, NOW(), 1, 'en', 'ZZZAUSER', 'ZZZAPASS', 'default Administrator', 'ZZZAMAIL', '', NOW(), 5, 1, '', 0, 1);
...
INSERT INTO modules (updated, id_area, name, title, configurable, admin, searchable, mappable, widget, hidden, pluggable, version, xlock, xon) VALUES (NOW(), 2, 'x4flags', 'Language switcher', 1, 0, 0, 0, 0, 0, 0, 1, 0 ,1);
...
INSERT INTO modules (updated, id_area, name, title, configurable, admin, searchable, mappable, widget, hidden, pluggable, version, xlock, xon) VALUES (NOW(), 2, 'x4get_by_key', 'Articles by key', 0, 0, 0, 0, 0, 0, 1, '0.9', 0, 1);
