...
INSERT INTO `pages` (`updated`, `lang`, `id_area`, `tpl`, `css`, `xfrom`, `xid`, `url`, `name`, `title`, `description`, `icon`, `xkeys`, `robot`, `redirect_code`, `redirect`, `id_menu`, `xpos`, `deep`, `ordinal`, `hidden`, `fake`, `xlock`, `xon`) VALUES
...
(NOW(),	'en',	1,	'base',	'x3ui',	'home',	'settings',	'sites',	'Settings',	'Settings',	'Settings',	'<i class="fa-solid fa-lg fa-fw fa-gear"></i>', '',	'',	0,	'',	3,	1,	1,	'A0031001',	0,	1,	1,	1),
