...
// create shortcut
define ('RESTLER_PATH', SPATH.'libraries/restler/');
...
class Restler {
	...
	public function __construct ($production_mode = FALSE) {
		...
		// reset cache dir
		$this->cache_dir = FPATH.'api_cache';
	...
	public function setSupportedFormats () {
		// include format
		include(RESTLER_PATH.'xmlformat.php');
	...
	*/
	protected function getPath () {
		...
		$_SERVER['SCRIPT_NAME']));
		*/
		$path = X4Route_core::$method.'/'.implode('/', X4Route_core::$args);
...
if(version_compare(PHP_VERSION, '5.3.0') < 0){
	require_once RESTLER_PATH.'compat.php';
}
