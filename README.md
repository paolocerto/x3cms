...
engine is a Php MVC Framework derived from Kohana (http://kohanaphp.com).t
...
X3 CMS include several projects
...
- Groundwork CSS: A Responsive HTML5, CSS & Javascript Framework (http://groundworkcss.github.io//)
- TCPDF: PHP class for generating PDF documents (http://www.tcpdf.org)
